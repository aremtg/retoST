...
function ProductNew() {
  ...
  return (
    ...
    <div className="max-w-md mx-auto my-8 p-6 bg-white rounded-xl shadow-md">
      ...
      <button
        className="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 my_button"
...
{ /* ... Resto del código ... */}
<Link to="/admin" className="text-white bg-blue-500 rounded-full p-3 fixed bottom-8 right-8">
